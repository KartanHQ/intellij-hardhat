package com.nekofar.milad.intellij.hardhat.diagnostic
...
class HardhatErrorReportSubmitter : ErrorReportSubmitter() {
    ...
    private fun getReportBody(events: Array<out IdeaLoggingEvent>, additionalInfo: String?): String {
        ...
        val plugin = PluginManagerCore.getPlugin(PluginId.getId("com.nekofar.milad.intellij.hardhat"))
    ...
    private fun getReportIssueUrl(title: String, body: String): URI? {
        val uriBuilder = URIBuilder("https://github.com/KartanHQ/intellij-hardhat/issues/new")
